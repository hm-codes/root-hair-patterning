...
ttest_count_results(1,:)=ttest_count(mean(results_GL2),std(results_GL2),numRepeats);
ttest_count_results(2,:)=ttest_count(mean(results_cpc),std(results_cpc),numRepeats);
ttest_count_results(3,:)=ttest_count(mean(results_WER),std(results_WER),numRepeats);
